...
final class LibavifFFmpegAvifReferenceTest {
    ...
    private static final FFmpegPixelReference @Unmodifiable [] ENABLED_PIXEL_REFERENCE_RESOURCES = new FFmpegPixelReference[]{
            ...
            pixelReference("libavif-test-data/io/kodim23_yuv420_8bpc.avif",
                    PixelTolerance.bounded(12, 0.0, 1.2, 1.4)),
            ...
            pixelReference("libavif-test-data/seine_hdr_rec2020.avif", PixelTolerance.bounded(1, 0.0, 0.75, 0.9)),
            pixelReference("libavif-test-data/seine_hdr_srgb.avif", PixelTolerance.bounded(1, 0.0, 0.75, 0.9)),
    ...
    private static final SourcePlaneReference @Unmodifiable [] ENABLED_SOURCE_PLANE_REFERENCE_RESOURCES = new SourcePlaneReference[]{
            ...
            sourcePlaneReference("libavif-test-data/io/cosmos1650_yuv444_10bpc_p3pq.avif",
                    SourcePlaneTolerance.perSampleDelta(6)),
            sourcePlaneReference("libavif-test-data/io/kodim03_yuv420_8bpc.avif",
                    SourcePlaneTolerance.bounded(9, 0.0, 0.13, 0.40)),
            sourcePlaneReference("libavif-test-data/io/kodim23_yuv420_8bpc.avif",
                    SourcePlaneTolerance.bounded(9, 0.0, 0.13, 0.40)),
            ...
            sourcePlaneReference("libavif-test-data/seine_hdr_rec2020.avif"),
            sourcePlaneReference("libavif-test-data/seine_hdr_srgb.avif"),
            ...
            sourcePlaneReference("libavif-test-data/sofa_grid1x5_420.avif", SourcePlaneTolerance.perSampleDelta(4)),
            sourcePlaneReference("libavif-test-data/sofa_grid1x5_420_dimg_repeat.avif", SourcePlaneTolerance.perSampleDelta(4)),
            sourcePlaneReference("libavif-test-data/sofa_grid1x5_420_reversed_dimg_order.avif", SourcePlaneTolerance.perSampleDelta(4)),
